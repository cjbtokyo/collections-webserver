...
public class SimpleWebServer extends Thread {
	 ...
	 * 
	 * @param rootDir
	 *            The root directory where the server should run
	 * @param port
	...
	/**
	 * Changes the root directory where the server runs. This method can be
	 * called while the server is running, and it will take effect right in the
	 * next request.
	 * 
	 * @param rootDir
	 *            the new directory.
	...
	public static void main(String[] args) {
		try {
			new SimpleWebServer(new File("./"), 1024);
